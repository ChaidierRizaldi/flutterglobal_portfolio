...
class IosAndApp2 extends StatelessWidget {
  @override
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          "Build the Boarding House app using the Flutter framework and the Dart programming language by implementing BLoC architecture, all the way to the deployment stage on Firebase App Distribution for testing",
